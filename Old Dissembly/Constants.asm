...
VDP_DATA		EQU	vdp_data_port			; VDP data port
VDP_CTRL		EQU	vdp_control_port			; VDP control port
VDP_HV			EQU	vdp_counter			; VDP H/V counter
...
oXVel       equ obVelX
oYVel       equ obVelY
oRoutine    equ obRoutine
oSubtype2   equ obSubtype
oVar2A      equ $2A
oRender     equ obRender
oPriority   equ obPriority
oMap        equ obMap
oTile       equ obGfx
oWidth      equ obActWid
oXRadius    equ obWidth
oYRadius    equ obHeight
oSubtype    equ obSubtype
oStatus     equ obStatus
oVar2E      equ $2E
oAnim       equ obAnim
oPrevAnim   equ obNextAni
oAnimFrame  equ obAniFrame
oAnimTime   equ obTimeFrame
oAngle      equ obAngle
oPlayerCtrl equ $2C
oPlayerGVel equ obInertia
oPlayerJump equ $3C
oPlayerStick equ $38
oMapFrame   equ obFrame
oRespawn    equ obRespawnNo
oColType    equ obColType
oVar30      equ $30
ovar2c      equ $2C
oRoutine2   equ ob2ndRout
...
obj.oX          equ obX
obj.oY          equ obY
obj.oXVel       equ obVelX
obj.oYVel       equ obVelY
obj.oRoutine    equ obRoutine
obj.oSubtype2   equ obSubtype
obj.oVar2A      equ $2A
obj.oflags     equ oStatus
obj.oPriority   equ obPriority
obj.osprites        equ obMap
obj.oTile       equ obGfx
obj.oWidth      equ obActWid
obj.oXRadius    equ obWidth
obj.oYRadius    equ obHeight
obj.oSubtype    equ obSubtype
obj.oStatus     equ obStatus
obj.oVar2E      equ $2E
obj.oAnim       equ obAnim
obj.oPrevAnim   equ obNextAni
obj.oAnimFrame  equ obAniFrame
obj.oAnimTime   equ obTimeFrame
obj.oAngle      equ obAngle
obj.oPlayerCtrl equ $2C
obj.oPlayerGVel equ obInertia
obj.oPlayerJump equ $3C
obj.oPlayerStick equ $38
obj.osprframe   equ obFrame
obj.oRespawn    equ obRespawnNo
obj.oColType    equ obColType
obj.oVar30      equ $30
obj.ovar2c      equ $2C
obj.oRoutine2   equ ob2ndRout
obj.oPlayerCharge			EQU	oVar2A		; Peelout/spindash charge timer
obj.oYScr       equ obScreenY    
obj.oVarE      equ $E  
obj.osprflags  equ obRender 
obj.ovar3a equ  objoff_3A 
obj.ovar3e equ  objoff_3E     
obj.ovar34 equ  objoff_34
obj.ovar3d equ  objoff_3D
obj.ovar32 equ  objoff_32
obj.ovar3b equ  objoff_3B
...
oPlayerHurt:equ flashtime
oColStatus equ  $21
oVar21     equ  oColStatus
oPlayerPushObj			EQU	oVar20
oVar20     equ  $20
oVarLen    equ  $40
; ---------------------------------------------------------------------------
...
bgm_PPZ_Past:	equ ((ptr_mus94-MusicIndex)/4)+bgm__First
