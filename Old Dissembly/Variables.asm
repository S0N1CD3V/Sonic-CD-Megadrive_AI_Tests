FFD000; Variables (v) and Flags (f)
...
ChunksInROMAddr: equ v_lvllayout-$4
...
v_objects           equ v_objspace
v_obj_shield        equ v_objspace+$180
v_obj_inv_star1     equ v_objspace+$200
v_obj_inv_star2     equ v_objspace+$240
v_obj_inv_star3     equ v_objspace+$280
v_obj_inv_star4     equ v_objspace+$2C0
v_obj_timewarp_star1 equ	v_objspace+$300
v_obj_timewarp_star2 equ	v_objspace+$340
v_obj_timewarp_star3 equ	v_objspace+$380
v_obj_timewarp_star4 equ	v_objspace+$3C0
v_obj_hud_time_icon equ     v_objspace+$400
v_obj_hud_score     equ     v_objspace+$440
v_obj_hud_lives     equ     v_objspace+$480
v_obj_hud_rings     equ     v_objspace+$4C0
...
;======================================================================================
;CD Variables
v_cam_fg_x:	        equ v_screenposx
v_update_time:	    equ f_timecount
v_left_bound:	    equ v_limitleft2
v_dest_left_bound:	equ v_limitleft1
v_boss_flags:	    equ v_bossstatus
v_got_time_stones:  equ v_emeralds
v_good_future:      equ $FFFFFFEA
v_vint_routine      equ v_vbla_routine
v_paused:           equ f_pause
v_obj_respawns      equ v_objstate
v_time_warp_dir     equ $FFFFF784
v_debug_mode        equ v_debuguse
v_bored_timer       equ $FFFFF5C0
v_p2_bored_timer    equ $FFFFF752
v_mini_sonic        equ $FFFFF5C2
v_life_count        equ v_lives
v_lvl_layout        equ v_lvllayout
v_sonic_last_frame  equ v_sonframenum
v_sonic_art         equ v_sgfx_buffer
v_sonic_frame_changed equ f_sonframechg
v_bottom_bound      equ v_limitbtm2
v_right_bound       equ v_limitright2
v_top_bound         equ v_limittop2
v_dest_top_bound    equ v_limittop1
v_scroll_diff_x     equ v_scrshiftx
v_deform_buffer     equ v_bgscroll_buffer
v_cam_fg_y          equ v_screenposy
v_cam_bg_y          equ v_bgscreenposy
v_vscroll           equ v_scrposy_dup
v_cam_bg2_y         equ v_bg2screenposy
v_cam_bg3_y         equ v_bg3screenposy
v_scroll_flags_bg3  equ v_bg3_scroll_flags
v_scroll_flags_bg2  equ v_bg2_scroll_flags
v_scroll_flags_bg   equ v_bg1_scroll_flags
v_layer_speeds      equ $FFFF1E00
v_cam_bg3_x         equ v_bg3screenposx
v_cam_bg2_x         equ v_bg2screenposx
v_cam_bg_x          equ v_bgscreenposx
v_hscroll           equ v_hscrolltablebuffer
v_time_zone:        equ $FFFFFFA0   ; TimeTravel (1 byte)   
v_cam_y_center:     equ v_lookshift   ; Camera Y Center (2 bytes)
v_dest_btm_bound:   equ $FFFFFFA4 ; bottom bound (2 bytes)
v_time_attack_mode  equ $FFFFFFA6
v_sonic_top_speed   equ v_sonspeedmax
v_sonic_acceleration equ v_sonspeedacc
v_sonic_deceleration equ v_sonspeeddec
v_frame_timer       equ v_framecount
v_level_blocks      equ v_16x16
v_time_warp_timer   equ $FFFFF786
v_camera_pan:       equ $FFFFF7A0    ; Extended Camera - how far the camera/view is panned to the left or right of Sonic (2 bytes)
v_debug_mode_enabled equ f_debugmode
v_ring_count        equ v_rings
v_frame_count       equ v_framecount
v_debug_block       equ $FFFFF7A2
v_update_score      equ $FFFF1511
v_update_rings      equ $FFFF150F
v_ctrl_locked       equ f_lockctrl
v_update_lives      equ f_lifecount
v_update_bonus_score equ f_endactbonus
v_bonus_countdown_1 equ v_timebonus
v_time_over         equ $FFFF150C
v_bonus_countdown_2 equ v_ringbonus
v_load_shield_art   equ $FFFF156B
v_dma_buffer        equ $FFFF1980
v_dma_cmd_cache     equ v_vdp_buffer2
v_cam_x_fg_copy     equ $FFFF1926
v_scroll_flags      equ v_fg_scroll_flags
v_scroll_flags_copy equ $FFFF1946
v_last_camera_plc   equ f_plc_execute
v_load_plc_flags    equ $FFFF151C
v_reset_lvl_flags   equ f_restart
UnkCDBossFlag       equ $FFFFFB20
v_display_low_plane equ $FFFF1956
v_time_stop_timer   equ $FFFF190E
v_1up_flags         equ f_lifecount
v_invincible        equ v_invinc
v_speed_shoes       equ v_shoes
v_blue_ring         equ $FFFF156F
v_no_title_card     equ $FFFF1571
v_cam_x_center      equ v_camera_pan
v_ctrl1_pressed     equ v_jpadpress1
v_ctrl1_held        equ v_jpadhold1
v_player_held       equ v_jpadhold2
v_time_warp_on      equ $FFFF1521
v_travel_1up_flags	equ $FFFF1545 
v_travel_reset_lvl_flags	equ $FFFF1546
v_travel_x 			equ $FFFF1548
v_travel_y 			equ $FFFF154A
v_travel_status		equ $FFFF154C
v_travel_btm_bound	equ $FFFF154E
v_travel_cam_fg_x	equ $FFFF1550
v_travel_cam_fg_y	equ $FFFF1552
v_travel_cam_bg_x	equ $FFFF1554
v_travel_cam_bg_y	equ $FFFF1556
v_travel_cam_bg2_x	equ $FFFF1558
v_travel_cam_bg2_y	equ $FFFF155A
v_travel_cam_bg3_x	equ $FFFF155C
v_travel_cam_bg3_y	equ $FFFF155E
v_travel_water_height2	equ $FFFF1560
v_travel_water_rout		equ $FFFF1562
v_travel_water_full		equ $FFFF1563
v_travel_gvel 			equ $FFFF1564
v_travel_xvel 			equ $FFFF1566
v_travel_yvel 			equ $FFFF1568
v_destroyed_projector	equ $FFFF156D
v_entered_big_ring		equ f_bigring
v_travel_time 			equ $FFFF1570
v_water_routine equ v_wtr_routine
v_water_height2 equ v_waterpos2
v_water_routine equ v_wtr_routine
v_water_full    equ f_wtr_state
v_travel_ring_count equ $FFFF1528
v_travel_mini_sonic equ $FFFF1593
v_level_restart equ f_restart
v_scroll_lock   equ f_nobgscroll
v_lvl_obj_man_rout equ v_opl_routine
v_obj_load_addr_right equ v_opl_data
v_obj_load_addr_left equ $FFFFF774
v_obj_load_addr2_right equ $FFFFF778
v_obj_load_addr2_left equ $FFFFF77C
v_obj_prev_cam_x equ v_opl_screen
v_dyn_objects equ v_lvlobjspace
v_objects_end equ v_snddriver_ram
v_sonic_record_index equ v_trackpos
v_sonic_record_buf equ v_tracksonic
v_pal_fade_flags equ v_pfade_start
v_last_checkpoint equ v_lastlamp
v_next_score_1up equ v_scorelife
v_horiz_blk_cross_flag_bg	equ v_bg1_xblock
v_verti_blk_cross_flag_bg	equ v_bg1_yblock
v_horiz_blk_cross_flag_bg2	equ v_bg2_xblock
v_horiz_blk_cross_flag_bg3	equ v_bg3_xblock
v_horiz_blk_crossed_flag    equ v_fg_xblock
v_btm_bound_shifting        equ f_bgscrollvert
v_scroll_diff_y             equ v_scrshifty
v_verti_blk_crossed_flag    equ v_fg_yblock
timeAttackMode equ $FFFFF601
amyCaptured equ $FFFFF60E
