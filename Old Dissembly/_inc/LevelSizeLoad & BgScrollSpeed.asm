...
LevelSizeArray:
		; GHZ
		dc.w $0004, $0000, $2897, $0000, $0710, $0060
		...
		; MZ
		dc.w $0004, $0000, $17BF, $0000, $06EB, $0060
...
LevSz_StartLoc:
		...
		lsl.b	#6,d0
		lsr.w	#4,d0
		lea	StartLocArray(pc),a1	
	    move.w	(a1,d0.w),d0
	    lea	(a1,d0.w),a0 ; load Sonic's start location
		cmpi.b #0,(v_time_zone).w ;Is Past
		bne.s  @NotPast
		lea	StartLocArrayPast(pc),a1	
	    move.w	(a1,d0.w),d0
	    lea	(a1,d0.w),a0
	@NotPast:
		cmpi.b #2,(v_time_zone).w ;Is Future
		bne.s  @NotFuture
		lea	StartLocArrayFuture(pc),a1	
	    move.w	(a1,d0.w),d0
	    lea	(a1,d0.w),a0
	@NotFuture:
		cmpi.b #3,(v_time_zone).w ;Is Good Future
		bne.s  @Continue
		lea	StartLocArrayGoodFuture(pc),a1	
	    move.w	(a1,d0.w),d0
	    lea	(a1,d0.w),a0
	@Continue:	
		...
		subq.w	#1,d0
		lsl.w	#2,d0
		lea	EndingStLocArray(pc),a1	 ; load Sonic's start location
        move.w	(a1,d0.w),d0
	    lea	(a1,d0.w),a0
LevSz_SonicPos:
		moveq	#0,d1
...
; ===========================================================================
BgScroll_Index:	dc.w BgScroll_PPZ-BgScroll_Index, BgScroll_LZ-BgScroll_Index
...
loc2_2A06:
		...
		add.w	d2,d2
		add.w	d1,d2
		move.w	d2,($FFFFF718).w
		lsr.w	#1,d1
		move.w	d1,d2
		add.w	d2,d2
		add.w	d1,d2
		move.w	d2,($FFFFF710).w
		lea	($FF1E00),a2
		moveq	#$12,d6
