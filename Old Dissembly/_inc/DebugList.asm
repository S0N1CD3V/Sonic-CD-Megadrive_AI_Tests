...
;		mappings	object		subtype	frame	VRAM setting
	...
	dbug	MapSpr_MonitorTimePost,	id_Monitor,	0,	0,	$5A8
	dbug	MapSpr_MonitorTimePost,	id_Monitor,	1,	1,	$5A8
	dbug	MapSpr_MonitorTimePost,	id_Monitor,	2,	2,	$5A8
	dbug	MapSpr_MonitorTimePost,	id_Monitor,	3,	3,	$5A8
	dbug	MapSpr_MonitorTimePost,	id_Monitor,	4,	4,	$5A8
	dbug	MapSpr_MonitorTimePost,	id_Monitor,	5,	5,	$5A8
	dbug	MapSpr_MonitorTimePost,	id_Monitor,	6,	6,	$5A8
	dbug	MapSpr_MonitorTimePost,	id_Monitor,	7,	7,	$5A8
	dbug	MapSpr_MonitorTimePost,	id_Monitor,	8,	8,	$5A8
	dbug	MapSpr_MonitorTimePost,	id_Monitor,	9,	9,	$5A8
	dbug	MapSpr_MonitorTimePost,	id_Monitor,	$A,	$A,	$5A8
	dbug	MapSpr_MonitorTimePost,	id_Monitor,	$B,	$B,	$5A8
	dbug	MapSpr_MonitorTimePost,	id_Monitor,	$C,	$C,	$5A8
	dbug	MapSpr_MonitorTimePost,	id_Monitor,	$D,	$D,	$5A8
	dbug	Spr_23BDB2,	id_BossGreenHill,	0,	0,	$5A8
	@GHZend:
...
;		mappings	object		subtype	frame	VRAM setting
	dbug	MapTTZBoss,	    $07,	0,	0,	$27B2
;	dbug	Map_Monitor,	$06,	0,	0,	$680
