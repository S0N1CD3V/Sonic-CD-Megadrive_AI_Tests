...
;		zonewarning StartLocArrayPast,$10
		...
		even
StartLocArrayPast_End		
; ===========================================================================
StartLocArrayFuture:
		incbin	"startpos\R11D.bin"
		incbin	"startpos\ghz2.bin"
		incbin	"startpos\ghz3.bin"
		dc.w	$80,$A8
...
;		zonewarning StartLocArrayPast,$10
		...
		even
StartLocArrayFuture_End	
; ===========================================================================
StartLocArrayGoodFuture:
		incbin	"startpos\R11C.bin"
		incbin	"startpos\ghz2.bin"
		incbin	"startpos\ghz3.bin"
		dc.w	$80,$A8
