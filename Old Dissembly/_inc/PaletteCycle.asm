...
; ---------------------------------------------------------------------------
PCycle_Index:	dc.w PCycle_PPZ-PCycle_Index
		dc.w Palcycle_Null-PCycle_Index
...
;loc_196A:				; XREF: PalCycle_Title
		...
		bpl.s	locret_1990	; if time remains, branch
...
PCycle_GHZ:
		lea ($FFFFFFB7).w,a5
		lea ($FFFFFFB0).w,a4
		lea	(PalCycle_PPZ_Script1).l,a1
		lea	(PalCycle_PPZ_Colors1).l,a2
		bsr.s	PalCyclePPZ_Do
		lea	(PalCycle_PPZ_Script2).l,a1
		lea	(PalCycle_PPZ_Colors2).l,a2
		bsr.s	PalCyclePPZ_Do
		lea	(PalCycle_PPZ_Script3).l,a1
		lea	(PalCycle_PPZ_Colors3).l,a2
		bsr.s	PalCyclePPZ_Do
		lea	(PalCycle_PPZ_Script4).l,a1
		lea	(PalCycle_PPZ_Colors4).l,a2
		bsr.s	PalCyclePPZ_Do
		lea	(PalCycle_PPZ_Script5).l,a1
		lea	(PalCycle_PPZ_Colors5).l,a2
		bsr.s	PalCyclePPZ_Do
		lea	(PalCycle_PPZ_Script6).l,a1
		lea	(PalCycle_PPZ_Colors6).l,a2
		
PalCyclePPZ_Do:
		subq.b	#1,(a5)
		bpl.s	PalCyclePPZ_Done
		moveq	#0,d0
		move.b	(a1)+,d0
		move.b	(a1)+,d1
		add.w	d0,d0
		...
		addq.b	#1,d0
		cmp.b	d1,d0
		bcs.s	PalCyclePPZ_DontReset
		moveq	#0,d0
		
PalCyclePPZ_DontReset:
		move.b	d0,(a4)
		add.w	d0,d0
		move.b	(a1,d0.w),(a5)
		move.b	1(a1,d0.w),d0
...
PalCycle_PPZ_Colors1:
		dc.w $EEE, $CC6, $EEA
; ===========================================================================

PalCycle_PPZ_Script2:
		dc.b $32
		dc.b 3
		dc.b 8, 0
		dc.b 8, 1
...
PalCycle_PPZ_Colors2:
		dc.w $EEA, $EEE, $CC6
; ===========================================================================

PalCycle_PPZ_Script3:
		dc.b $33
		dc.b 3
		dc.b 8, 0
		dc.b 8, 1
...
PalCycle_PPZ_Colors3:
		dc.w $CC6, $EEA, $EEE
; ===========================================================================

PalCycle_PPZ_Script4:
		dc.b $2C
		dc.b 3
		dc.b 6, 0
		dc.b 6, 1
...
PalCycle_PPZ_Colors4:
		dc.w $ECA, $EA8, $E86
; ===========================================================================

PalCycle_PPZ_Script5:
		dc.b $2D
		dc.b 3
		dc.b 6, 0
		dc.b 6, 1
...
PalCycle_PPZ_Colors5:
		dc.w $EA8, $E86, $ECA
; ===========================================================================

PalCycle_PPZ_Script6:
		dc.b $2F
		dc.b 3
		dc.b 6, 0
		dc.b 6, 1
