...
ptr_PLC_TTZBoss:		dc.w PLC_TTZBoss-ArtLoadCues
ptr_PLC_TTZBoss2:		dc.w PLC_TTZBoss2-ArtLoadCues
...
ptr_PLC_GHZ_2:		dc.w PLC_GHZ_2-ArtLoadCues
ptr_PLC_GHZ2_2:		dc.w PLC_GHZ2_2-ArtLoadCues
...
PLC_Main2:	dc.w ((PLC_Main2end-PLC_Main2-2)/6)-1
		plcm	Nem_TimePost, $B500	; Timepost
...
PLC_GameOver:	dc.w ((PLC_GameOverend-PLC_GameOver-2)/6)-1
	...
	PLC_GameOverend:
; ---------------------------------------------------------------------------
; Pattern load cues - Green Hill Act 1
; ---------------------------------------------------------------------------
PLC_GHZ:	dc.w ((PLC_GHZ2-PLC_GHZ-2)/6)-1
;		plcm	Nem_GHZ_2nd, 0		; GHZ main patterns
...
PLC_GHZ2:	dc.w ((PLC_GHZ2end-PLC_GHZ2-2)/6)-1
        plcm	Nem_3DRamp, $6400		; 3D Ramp
        plcm	Nem_Mosqui, $8080		; Mosqui
		plcm	Nem_Flower_Capsule, $8620		; Flower Capsule
...
;		plcm	Nem_GhzWall2, $6980	; normal wall
	PLC_GHZ2end:
; ---------------------------------------------------------------------------
; Pattern load cues - Green Hill Act 2
; ---------------------------------------------------------------------------
PLC_GHZ_2:	dc.w ((PLC_GHZ2_2-PLC_GHZ_2-2)/6)-1
;		plcm	Nem_PPZ_2, 0		; GHZ main patterns
		plcm	Nem_Spikes, $A360	; spikes
		plcm	Nem_HSpring, $A460	; horizontal spring
		plcm	Nem_VSpring, $A660	; vertical spring

PLC_GHZ2_2:	dc.w ((PLC_GHZ2_2end-PLC_GHZ2_2-2)/6)-1
;        plcm	Nem_3DRamp, $6400		; 3D Ramp
;        plcm	Nem_Mosqui, $8080		; Mosqui
		plcm	Nem_Flower_Capsule, $8620		; Flower Capsule
	PLC_GHZ2_2end:	
...
; ---------------------------------------------------------------------------
PLC_LZ:		dc.w 1 ;((PLC_LZ2-PLC_LZ-2)/6)-1
;		plcm	Nem_LZ,0		; LZ main patterns
	;	plcm	NemTonBon, $A880	; block
...
PLC_LZ2:	dc.w 1;((PLC_LZ2end-PLC_LZ2-2)/6)-1
		plcm	Nem_LzPole, $7BC0	; pole that breaks
		plcm	NemTonBon, $416*$20
...
; ---------------------------------------------------------------------------
PLC_TTZBoss:	dc.w ((PLC_Bossend-PLC_TTZBoss-2)/6)-1
		plcm	Nem_TTZEggman, $63C0	; Eggman main patterns
...
; Pattern load cues - act 3 boss
; ---------------------------------------------------------------------------
PLC_TTZBoss2:	dc.w ((PLC_Bossend2-PLC_TTZBoss2-2)/6)-1
		plcm	Nem_TTZEggman2, $63C0	; Eggman main patterns
;		plcm	Nem_Weapons, $8D80	; Eggman's weapons
;		plcm	Nem_Prison, $93A0	; prison capsule
		plcm	Nem_Bomb, $A300		; bomb enemy ((gets overwritten)
;		plcm	Nem_SlzSpike, $A300	; spikeball ((SLZ boss)
...
plcid_Boss:         equ plcid_TTZBoss
plcid_TTZBoss:		equ (ptr_PLC_TTZBoss-ArtLoadCues)/2	; $11
plcid_TTZBoss2:		equ (ptr_PLC_TTZBoss2-ArtLoadCues)/2	; $11
...
plcid_GHZ_2:		equ (ptr_PLC_GHZ_2-ArtLoadCues)/2		; $20
plcid_GHZ2_2:		equ (ptr_PLC_GHZ2_2-ArtLoadCues)/2	; $21